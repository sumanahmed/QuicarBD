...
<div class="container-fluid">               
    ...
    <div class="row heading-bg">
        ...
        <div class="col-md-md-md-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <li class="active"><span>Hotel or Resort Package Details</span></li>
            </ol>
        </div>
        <!-- /Breadcrumb -->
    </div>
                        ...
                        <div class="row">
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="hotel_name" name="hotel_name" value="{{ $hotel_package->hotel_name }}" class="form-control" placeholder="Hotel or Resort Name" readonly>
                            ...
                            <div class="col-md-3">                                        
                                <div class="form-group">
                                    ...
                                    <input type="text" id="area" name="area" value="{{ $hotel_package->area }}" class="form-control" placeholder="Area" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">                                        
                                <div class="form-group">
                                    <label for="propertyType" class="control-label mb-10"> Property Type <span class="text-danger" title="readonly">*</span></label>                                            
                                    <input type="text" id="area" name="area" value="{{ $hotel_package->property_type }}" class="form-control" placeholder="Area" readonly>
                                </div>
                            </div>
                            <div class="col-md-4">                                        
                                <div class="form-group">
                                    <label for="room_type" class="control-label mb-10"> Room Type </label>
                                    <input type="text" id="room_type" name="room_type" value="{{ $hotel_package->room_type }}" class="form-control" placeholder="Room Type" readonly>
                            ...
                            <div class="col-md-4">                                        
                                <div class="form-group">
                                    ...
                                    <input type="text" id="room_size" name="room_size" value="{{ $hotel_package->room_size }}" class="form-control" placeholder="Room Size" readonly>
                            ...
                            <div class="col-md-4">                                        
                                <div class="form-group">
                                    ...
                                    <input type="text" id="hotel_website" name="hotel_website" value="{{ $hotel_package->hotel_website }}" class="form-control" placeholder="Hotel Website" readonly>
                            ...
                            <div class="col-md-4">                                        
                                <div class="form-group">
                                    ...
                                    <input type="text" id="referrel_code" name="referrel_code" value="{{ $hotel_package->referrel_code }}" class="form-control" placeholder="Referrel Code" readonly>
                        ...
                        <div class="row">
                            <div class="col-md-2">                                        
                                <div class="form-group">
                                    ...
                                    <input type="text" id="quicar_charge" name="quicar_charge" value="{{ $hotel_package->quicar_charge }}" class="form-control" placeholder="Quicar Charge(%)" readonly>                                   
                                </div>
                            </div> 
                            <div class="col-md-2">                                        
                                <div class="form-group">
                                    <label for="price" class="control-label mb-10"> Price <span class="text-danger" title="readonly">*</span></label>
                                    <input type="text" id="price" name="price" oninput="calculateCharge()" value="{{ $hotel_package->price }}" class="form-control" placeholder="Price" readonly>
                                    @if($errors->has('price'))
                            ...
                            <div class="col-md-2">                                        
                                <div class="form-group">
                                    ...
                                    <input type="text" id="you_will_get" name="you_will_get" value="{{ $hotel_package->you_will_get }}" class="form-control" placeholder="Partner Get" readonly>
                            ...
                            <div class="col-md-3">                                        
                                <div class="form-group">
                                    ...
                                    <input type="text" id="cash_back_price" name="cash_back_price" value="{{ $hotel_package->cash_back_price }}" class="form-control" placeholder="Cash Back Price" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" readonly>
                                </div>
                            </div>                                         
                            <div class="col-md-3">                                        
                                <div class="form-group">
                            ...
                            <div class="col-md-3">                                        
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" id="cash_back_staring_time" name="cash_back_staring_time"  @if($hotel_package->cash_back_staring_time != null) value="{{ date('Y-m-d\TH:i:s', strtotime($hotel_package->cash_back_staring_time)) }}" @endif class="form-control" readonly>
                                </div>
                            </div>
                            <div class="col-md-3">                                        
                                <div class="form-group">
                                    <label for="cash_back_ending_time" class="control-label mb-10">Cash Back End Time </label>
                                    <input type="datetime-local" id="cash_back_ending_time" name="cash_back_ending_time" @if($hotel_package->cash_back_staring_time != null) value="{{ date('Y-m-d\TH:i:s', strtotime($hotel_package->cash_back_staring_time)) }}" @endif class="form-control" readonly>
                                </div>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-3">                                        
                                <div class="form-group">
                                    ...
                                    <input type="text" id="booking_contact_number" name="booking_contact_number" value="{{ $hotel_package->booking_contact_number }}" class="form-control" placeholder="Booking Contact Number" readonly>
                            ...
                            <div class="col-md-3">                                        
                                <div class="form-group">
                                    ...
                                    <input type="text" id="facebook_page" name="facebook_page" value="{{ $hotel_package->facebook_page }}" class="form-control" placeholder="Facebook Page" readonly>
                        ...
                        <div class="row">
                            <div class="col-md-3">                                        
                                <div class="form-group">
                                    ...
                                    <input type="time" id="hotel_check_in_time" name="hotel_check_in_time" value="{{ date('H:i:s', strtotime($hotel_package->hotel_check_in_time)) }}" class="form-control" placeholder="Hotel Check In Time" readonly>
                            ...
                            <div class="col-md-3">                                        
                                <div class="form-group">
                                    ...
                                    <input type="time" id="hotel_check_out_time" name="hotel_check_out_time" value="{{ date('H:i:s', strtotime($hotel_package->hotel_check_out_time)) }}" class="form-control" placeholder="Hotel Check Out Time" readonly>
                            ...
                            <div class="col-md-6">                                        
                                <div class="form-group">
                                    <label for="facilities" class="control-label mb-10"> Factilites <span class="text-danger" title="readonly">*</span></label>                                                                                       
                                    <select id="facilities" name="facilities[]" class="form-control selectable" multiple readonly>  
                        ...
                        <div class="row">                                     
                            <div class="col-md-6">                                        
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control" id="booking_policy" name="booking_policy" placeholder="Booking Policy" rows="3" readonly>{{ $hotel_package->booking_policy }}</textarea>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="avatar-upload">
                                        <div class="avatar-edit">
                                            <input type='file' name="hotel_image" id="hotelImgUpload" accept=".png, .jpg, .jpeg" readonly/>
                            ...
                            <div class="col-md-6">                                        
                                <div class="form-group">
                                    ...
                                    <div class="avatar-upload">
                                        <div class="avatar-edit">
                                            <input type='file' name="room_image" id="roomImgUpload" accept=".png, .jpg, .jpeg" readonly/>
