                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">                                        
                                                    <div class="form-group">
                                                        ...
                                                        <input type="email" id="email" name="email" value="{{ old('email') }}" placeholder="Enter Email Address" class="form-control" required>
                                                        @if($errors->has('email'))
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="phone" id="phone" name="phone" value="{{ old('phone') }}" placeholder="Enter Phone Number" class="form-control" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" required>
                                                        @if($errors->has('phone'))
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="nid" id="nid" name="nid" value="{{ old('nid') }}" placeholder="Enter NID Number" class="form-control" required>
                                                        @if($errors->has('nid'))
