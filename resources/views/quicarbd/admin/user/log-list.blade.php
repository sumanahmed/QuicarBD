            ...
            <div class="panel panel-default card-view">
                ...
                <div class="panel-wrapper collapse in">
                    <div class="panel-header" style="border-bottom: 2px solid #ddd;margin-top:10px;">
                        <form action="{{ route('user.user_log_list') }}" method="get">
                            <div class="row">
                                <div class="col-md-2">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="visit_date" class="control-label mb-10">Visit Date</label>                                            
                                        <input type="date" name="visit_date" @if(isset($_GET['visit_date'])) value="{{ $_GET['visit_date'] }}" @endif class="form-control">
                                    </div>
                                </div> 
                                <div class="col-md-2">
                                <div class="col-md-2">
