...
<div class="container-fluid">               
    ...
    <div class="row heading-bg">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <li class="active"><span>Online Transaction History</span></li>
            </ol>
        </div>
        <!-- /Breadcrumb -->
    </div>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Online Transaction History</h6>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="panel-wrapper collapse in">
                    <div class="panel-header" style="border-bottom: 2px solid #ddd;margin-top:10px;">
                        <form action="{{ route('accounts.online_transaction') }}" method="get">
                            <div class="row">
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label class="control-label mb-10">Tnx ID</label>                                            
                                        <input type="text" name="tnx_id" @if(isset($_GET['tnx_id'])) value="{{ $_GET['tnx_id'] }}" @endif placeholder="Enter Tnx ID.." class="form-control" />
                                    </div>
                                </div>  
                                <div class="col-md-2">
                                    <div class="form-group">
