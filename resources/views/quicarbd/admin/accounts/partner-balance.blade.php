        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Partner Balance</h6>
                    </div>
                    <div class="clearfix"></div>
                </div>
                <div class="panel-wrapper collapse in">
                    <div class="panel-header" style="border-bottom: 2px solid #ddd;margin-top:10px;">
                        <form action="{{ route('accounts.partner-balance') }}" method="get">
                            <div class="row">
                                <div class="col-md-2">
                                    ...
                                    <tbody id="carData">
                                        @foreach($balances as $balance)
                                            <tr>
                                                ...
                                                <td>{{ $balance->total_commission }}</td>
