...
<div class="container-fluid">				
    ...
    <div class="row heading-bg">
        <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
            <button type="button"data-toggle="modal" data-target="#createCarTypeModal" class="btn btn-success btn-anim"><i class="icon-plus"></i><span class="btn-text">Add New</span></button>
        </div>
        <!-- Breadcrumb -->
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <li class="active"><span>Car Type</span></li>
            </ol>
        </div>
        <!-- /Breadcrumb -->
    </div>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">All Car Type</h6>
                    </div>
    ...
    <div class="modal fade" id="createCarTypeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="seat" class="control-label mb-10">Seat <span class="text-danger text-bold" title="Required Field">*</span></label>
    ...
    <div class="modal fade" id="editCarTypeModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel1">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                ...
                <div class="modal-body">
                    <form>
                        ...
                        <div class="form-group">
                            <label for="edit_seat" class="control-label mb-10">Seat <span class="text-danger text-bold" title="Required Field">*</span></label>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content text-center">
                <div class="modal-header">
                    ...
                    <button type="button" class="btn btn-xs btn-danger btn-raised mr-2" id="destroyCarType"><i class="fas fa-trash-alt"></i> Proceed</button>
...
@endsection
@section('scripts')
	<script src="{{ asset('quicarbd/admin/js/car-type.js') }}"></script>
    <script>
