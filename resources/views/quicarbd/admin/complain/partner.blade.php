        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="panel-title txt-dark">Partner Complain</h6>
                    </div>
                                    ...
                                    <tbody id="partnerData">
                                        @foreach($complains as $complain)
                                            @php 
                                                ...
                                                $complainTime   = $db_time->setTimeZone(new DateTimeZone("Asia/Dhaka"))->format('j M, Y h:i A');
                                                if($complain->answer_time != null) {
                                                    $reply_time     = DateTime::createFromFormat('Y-m-d H:i:s', $complain->answer_time, new DateTimeZone("UTC"));
                                                    $answerTime     = $reply_time->setTimeZone(new DateTimeZone("Asia/Dhaka"))->format('j M, Y h:i A');
                                                }
                                            @endphp
                                            <tr class="complain-{{ $complain->id }}">
                                                ...
                                                <td style="vertical-align: middle;text-align: center;">
                                                    <a href="#" class="btn btn-xs btn-warning" data-toggle="modal" id="replyComplain" data-id="{{ $complain->id }}" data-complain="{{ $complain->message }}" data-sender_id="{{ $complain->sender_id }}" data-type="2" title="Reply"><i class="fa fa-reply"></i></a>
