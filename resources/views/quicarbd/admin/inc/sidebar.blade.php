    ...
    <ul class="nav navbar-nav side-nav nicescroll-bar">
        ...
        <li>
            ...
            <ul id="bonus" class="collapse collapse-level-1 two-col-list">
                <li>
                    <a href="{{ route('bonus.index',['type' => 1]) }}">Partner</a>
                </li>
                <li>
                    <a href="{{ route('bonus.index',['type' => 0]) }}">User</a>
                </li>
            </ul>
        </li>
        <li>
            ...
            <ul id="packageRide" class="collapse collapse-level-1 two-col-list">
                <li>
                    ...
                    <ul id="rideCarPackage" class="collapse collapse-level-1 two-col-list">
                        <li>
                            <a href="{{ route('car_package_order.booking') }}">Booking Request
                                <div class="pull-right"><span class="label label-warning">{{ $booking_car_package_ride }}</span></div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('car_package_order.accepted') }}">Accepted
                                <div class="pull-right"><span class="label label-warning">{{ $accepted_car_package_ride != 0 ? $accepted_car_package_ride : '' }}</span></div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('car_package_order.upcoming') }}">Upcoming Trip
                                <div class="pull-right"><span class="label label-warning">{{ $upcoming_car_package_ride != 0 ? $upcoming_car_package_ride : '' }}</span></div>
                            </a>
                        </li>
                        <!--<li><a href="{{ route('car_package_order.ongoing') }}">Ongoing Trip</a></li>-->
                        <li>
                            <a href="{{ route('car_package_order.complete') }}">Complete Trip 
                                <div class="pull-right"><span class="label label-warning">{{ $complete_car_package_ride != 0 ? $complete_car_package_ride : '' }}</span></div>
                            </a>
                        </li>
                        <li>
                            <a href="{{ route('car_package_order.cancel') }}">Cancelled Trip 
                                <div class="pull-right"><span class="label label-warning">{{ $cancel_car_package_ride != 0 ? $cancel_car_package_ride : '' }}</span></div>
                            </a>
                        </li>
                    </ul>
                </li>
