...
<div class="container-fluid">				
    ...
    <div class="row heading-bg">
        ...
        <div class="col-lg-9 col-sm-8 col-md-8 col-xs-12">
            ...
            <li class="active"><span>Edit {{ $title }} Notice</span></li>
            </ol>
        </div>
        <!-- /Breadcrumb -->
    </div>
        ...
        <div class="col-sm-12">
            <div class="panel panel-default card-view">
                <div class="panel-heading">
                    <div class="pull-left">
                        <h6 class="txt-dark capitalize-font"></i>{{ $title }} Notice</h6> 
                    </div>
                    ...
                    <div class="panel-body">
                        <div class="row">
                            <div class="col-sm-12 col-xs-12">
                                <div class="form-wrap">
                                    <form action="{{ route('notice.packages.update') }}" method="post" enctype="multipart/form-data" novalidate>
                                        @csrf
                                        <div class="form-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <textarea name="{{ $name }}" class="form-control" rows="6">
                                                            ...
                                                            @elseif($type == 1)
                                                                {{ $notice->car_package_homepage_notice }}
                                                            @elseif($type == 2)
                                                                {{ $notice->hotel_package_homepage_notice }}
                                                            @else 
                                                                {{ $notice->travel_group_homepage_notice }}
                                                            @endif
                                                        </textarea>
