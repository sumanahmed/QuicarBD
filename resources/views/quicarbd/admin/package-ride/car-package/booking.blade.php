                                            ...
                                            @foreach($bookings as $booking)
                                                <tr class="partner-{{ $booking->id }}">
                                                    ...
                                                    <td style="vertical-align: middle;text-align: center;">
                                                        <a href="#}" target="_blank" class="btn btn-xs btn-info" title="Details"><i class="fa fa-eye"></i></a>
                                                        <a href="#" id="cancelModal" data-toggle="modal" data-ride_id="{{ $booking->id }}" class="btn btn-xs btn-danger" title="Cancel"><i class="fa fa-remove"></i></a>
                                                    </td>
                                                </tr>
                                            @endforeach
                                        @else
